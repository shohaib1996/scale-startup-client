...
>(({ className, children, ...props }, ref) => (
    ...
    >
        {children}
        {/* ChevronDown icon hidden on small devices and visible on larger screens */}
...
>(({ className, children, position = 'popper', ...props }, ref) => (
    <SelectPrimitive.Portal>
        <SelectPrimitive.Content
            ref={ref}
            className={cn(
                'bg-popover text-popover-foreground relative z-50 min-w-[7rem] overflow-hidden rounded-md border shadow-md animate-in fade-in-80',
